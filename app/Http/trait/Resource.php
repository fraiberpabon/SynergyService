...
trait Resource
{
    ...
    public function wbMaterialListaToModel($modelo): array
    {
        return [
            ...
            'estado' => $modelo->Estado,
            'fecha' => $modelo->dateCreate,
            'materialTipo' => $modelo->fk_id_material_tipo,
            'solicitable' => $modelo->Solicitable,
            'usuario' => $modelo->userCreator,
            'objectMaterialTipo' => $modelo->objectMaterialTipo,
            'capas' => $modelo->capas,
            'centrosProduccion' => $modelo->centrosProduccion,
        ];
    }
    ...
    public function equipoToModel($modelo): array
    {
        return [
            ...
            'fecha_registro' => $modelo->created_at,
            'fecha_actualizacion' => $modelo->updated_at,
            'usuario_creador' => $modelo->fk_user_creador,
            'usuario_modificador' => $modelo->fk_user_update,
            'cantidad' => $modelo->CANTIDAD,
            'objectCompania' => $modelo->objectCompania,
            'objectPeso' => $modelo->objectPeso,
            'idTipoEquipo' => $modelo->idTipoEquipo,
            'nombreTipoEquipo' => $modelo->nombreTipoEquipo,
